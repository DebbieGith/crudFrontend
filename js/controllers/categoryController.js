...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    btnAdd.addEventListener("click", ()=>{
        form.reset();
        form.categoryId.value = ""; //Al aregar no necesitamos un ID, por eso no se coloco nada en las comillas
    ...
    async function loadCategories() {
        try{
            ...
            if(!categories || categories.length == 0){
                ...
                return; //El codigo deja ejecutarse
            }

            categories.forEach((cat)=>{
                const tr = document.createElement("tr"); // definamos un TR en JS
            ...
            `;
             ...
             //Funcionalidad para boton de editar cateogria
                ...
                tableBody.appendChild(tr);  //Al tbdody le agrega el <tr> creado.
